...
3.因设备硬件不支持仅通过HDR10+及自研算法映射DolbyVison至Rec.709RGB，会与出厂认证支持的DolvyVison设备显示存在差异。</br>
4.因原厂底层显示链路写的稀烂，没有安全的nit调试线路，暂不添加适配动态HDR/SDR比率功能，观看DolbyVison视频请自行拉高亮度至最高。</br>
